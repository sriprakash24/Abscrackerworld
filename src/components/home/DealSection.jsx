    ...
    <div className="mb-5 px-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="surface-3d relative flex min-h-[230px] flex-col overflow-hidden rounded-[20px] p-3.5">
          ...
          <div className="art-float my-2 text-center text-[46px] leading-none">
            🎇
          </div>
          <div className="mb-2 flex justify-center gap-1.5">
            {[
              ...
              <div
                key={label}
                className="orb-3d px-1.5 py-1 text-center !rounded-lg"
              >
          ...
          <div className="mb-0.5 text-[12px] font-bold leading-tight text-white"></div>
        ...
        <div className="surface-3d relative flex min-h-[230px] flex-col overflow-hidden rounded-[20px] p-3.5">
          <div className="mb-1 inline-flex w-fit items-center gap-1 rounded-full bg-gold/15 px-2 py-0.5 text-[10px] font-extrabold tracking-wide text-gold shadow-[0_1px_0_rgba(255,220,170,.15)_inset]">
            <span className="rounded bg-gradient-to-b from-[#ffe9a8] to-gold px-1 text-[9px] font-black text-[#1a0d00]">
              NEW
            </span>
            NEW ARRIVALS
          </div>
