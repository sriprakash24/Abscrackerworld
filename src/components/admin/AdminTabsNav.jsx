...
import { LayoutDashboard, ClipboardList, PackageSearch, Boxes, LayoutGrid, Receipt, Users, BadgePercent } from 'lucide-react';
...
const TABS = [
  ...
  { to: '/admin/price-update', label: 'Price Update', icon: BadgePercent, end: false },
